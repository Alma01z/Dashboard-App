...
<head>
    ...
    <!-- site metas -->
    <title>Dashboard Emplofyee Panel</title>
            ...
            <nav id="sidebar">
                <div class="sidebar_1">
                    ...
                    <div class="sidebar_user">
                        ...
                        <div class="user_profle">
                            <div class="user_img"><img class="img-responsive" src="images/layout_img/employee.jpg"
                                    alt="#" /></div>
                            <div class="user_info">
                                <h6>Timothy Pitts</h6>
                            </div>
                ...
                <div class="sidebar_2 margin_top_30">
                    <ul class="list-unstyled components">
                        <li><a href="daily-employee.php"><i class="fa fa-tasks white_color"></i> <span>Daily
                                    Tasks</span></a>
                        </li>
                        <li><a href="employee-job.php"><i class="fa fa-list" aria-hidden="true"></i>
                                <span>Your jobs</span></a>
                        </li>
                    </ul>
                </div>
            </nav>
                                    ...
                                    <ul class="user_profile_right">
                                        <li>
                                            <a class="dropdown-toggle" data-toggle="dropdown"><span
                                                    class="name_user">Timothy Pitts</span></a>
